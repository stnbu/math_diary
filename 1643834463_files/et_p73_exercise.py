...
f_plot = plot_implicit(Eq(x**2 + y + 4, 0), xvar=(x, -5, 5), yvar=(y, -8, 2), show=False, backend="matplotlib")
l_plot = plot_parametric((2*t + 1, t - 5), xlim=(-2.5, 2.5), ylim=(-8, -2), show=False, backend="matplotlib")
