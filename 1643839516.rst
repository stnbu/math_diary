...
** Letting the `z` of a homogenized polynomial in `x,y` has the effect of straightening the curve. With `z=0` the resulting curve is a straight line with the slope of `[a : b: 0]`; the point at infinity that ends the original polynomial **
...
.. program-output:: python3 1643839516_files/projective.py
   :nostderr:
